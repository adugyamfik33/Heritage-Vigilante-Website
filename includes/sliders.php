    ...
    <div class="carousel-inner">
        ...
        <div class="item active" style="background-image:url(images/slider-main/bg1.jpg)">
            <div class="slider-content">
                <div class="col-md-12 text-center">
                    <h3 class="slide-sub-title animated5">Heritage Vigilant</h3>
                    <h2 class="slide-title animated4">We Are Under Control</h2><br>
        ...
        <div class="item" style="background-image:url(images/slider-main/bg2.jpg)">
            <div class="slider-content text-right">
                <div class="col-md-12">
                    <h2 class="slide-title animated6">Meet Our Guards</h2>
                    <h3 class="slide-sub-title animated7">We believe in Security</h3>
        ...
        <div class="item" style="background-image:url(images/slider-main/bg3.jpg)">
            <div class="slider-content text-left">
                <div class="col-md-12">
                    ...
                    <h3 class="slide-sub-title animated3">Security Dogs in Control</h3>
                    <p class="animated3">
